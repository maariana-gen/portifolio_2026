    ...
    try {
        ...
        about.innerHTML = `
            ...
            <article class="about-content">
                <h2>Sobre mim</h2>
                <p>
                    Sou técnica em Mecânica, com experiência em produção industrial e suporte técnico, 
                    atuando na organização de processos e na elaboração de relatórios e documentações de máquinas. 
                    Possuo sólido conhecimento em leitura de documentação técnica, controle de atividades operacionais 
                    e trabalho em equipe, além de experiência em projetos voltados ao atendimento ao público 
                    e relacionamento com clientes. Tenho um perfil proativo, responsável e comunicativo, o que me permite aprender rapidamente 
                    e contribuir para a eficiência das atividades da equipe.
                </p>
                
                <p>
                    Como desenvolvedora JavaScript em formação, possuo habilidades em lógica de programação e resolução de problemas, 
                    desenvolvendo soluções funcionais e me adaptando com facilidade a novas tecnologias.
                </p>

                <div class="about-buttons-data">
                    <div class="buttons-container">
                        <a href="${perfil.html_url}" target="_blank" class="botao">Ver GitHub</a>
                        <a href="https://drive.google.com/file/d/15I9Diwo6S3_O7JIfQJbo1iw1NLDe_hj6/view?usp=sharing" target="_blank" class="botao-outline">Currículo</a>
                    </div>
...
async function getProjectsGithub() {
    try {
        ...
        const resposta = await fetch('https://api.github.com/users/maariana-gen/repos?sort=updated&per_page=6');
